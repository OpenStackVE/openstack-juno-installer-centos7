#!/bin/bash
#
# Instalador desatendido para Openstack Juno sobre CENTOS
...
#
# Script principal
# Versión 0.0.4.beta.el7 "Shadow Cat"
...
"install")
	...
	echo ""
	echo "INSTALADOR DE OPENSTACK JUNO PARA CENTOS/RHEL/SCIENTIFIC-LINUX 7"
	echo "Para releases 7.0 en adelante"
	echo "Realizado por Reynaldo R. Martinez P."
	echo "E-Mail: TigerLinux@Gmail.com"
	echo "Versión 0.0.4.beta.el7 \"Shadow Cat\" - Octubre 15, 2014"
	echo ""
	...
	echo "  * rdo:  http://repos.fedorapeople.org/repos/openstack/openstack-icehouse/epel-7/"
